...
$.readme = `
0 * * * * task ${$.runfile}
exprot ${$.runfile}=40  #如需增加兑换账号,在这边修改人数
如果有红包,会显示正在兑换
`
